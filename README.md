...
※ Renderの無料プランの仕様により、初回アクセス時に数十秒の起動待ちが発生します。
...
※ 本アプリはMVPとしてコア機能の実装を優先しているため、UIの細かなデザイン調整は最低限に留めています。  
特に一般ユーザーのトップ画面は、年配者でも見やすいよう文字サイズを大きくし、操作を分かりやすく設計しています。  
一方で、他の画面は統一が不十分なため、今後は全体のUIを統一し、ユーザビリティの向上を図る予定です。
